...
LOCAL_APPS = [
    "gamifyme.users.apps.UsersConfig",
...
MIGRATION_MODULES = {
    "sites": "gamifyme.contrib.sites.migrations"
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "gamifyme.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "gamifyme.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = (
    "gamifyme.users.adapters.SocialAccountAdapter"
)
